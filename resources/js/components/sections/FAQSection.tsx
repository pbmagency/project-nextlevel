...
const FAQS = [
    { q: 'Siapa saja yang cocok mengikuti training ini?', a: 'Training ini dirancang untuk siapa saja yang bekerja di bidang penjualan — sales asuransi, properti, otomotif, medical representative, network marketing, hingga pemilik bisnis yang ingin timnya closing lebih konsisten. Baik yang baru terjun ke dunia sales maupun yang sudah berpengalaman tapi hasilnya stagnan.' },
    { q: 'Apakah materinya bisa langsung diterapkan setelah training?', a: 'Ya — itulah keunggulan utama program ini. Semua materi berbasis pengalaman nyata 20+ tahun di lapangan, bukan teori akademis. Anda akan pulang dengan teknik dan framework konkret yang bisa langsung dicoba keesokan harinya saat bertemu prospek.' },
    { q: 'Apakah dengan ikut program ini saya pasti bisa closing lebih baik?', a: 'Setiap peserta datang dengan skala kemampuan yang berbeda. Yang kami jamin adalah: selama 1 hari penuh mengikuti sesi teori dan praktek yang kami fasilitasi, pasti ada kemajuan nyata dibanding sebelum training. Tingkat kemajuan masing-masing orang berbeda, karena sales adalah skill yang perlu terus diasah setelah training.' },
    { q: 'Apa yang dimaksud batch berikutnya bisa diikuti gratis?', a: 'Sebagai alumni, Anda bisa hadir kembali di batch berikutnya tanpa biaya tambahan untuk Reseat atau me-refresh materi. Program ini diadakan 6 bulan sekali — jadwal batch berikutnya bisa ditanyakan langsung ke panitia. Catatan: fasilitas Lunch di Hotel tidak termasuk untuk sesi Reseat.' },
    { q: 'Bagaimana metode yang diterapkan di program ini?', a: 'Kelas sengaja dibuat kecil — maksimal 30 orang — dengan pendampingan langsung Coach Haryanto Kandani dan Asisten Coach. Setiap teknik dipraktekkan langsung dan diberikan feedback real-time. Ada juga sesi Coaching One on One. Setelah training, peserta masuk ke WhatsApp Group untuk mentoring dan pendampingan lanjutan.' },
    { q: 'Apa maksudnya Money Back Guarantee?', a: 'Kami bertanggung jawab penuh atas kepuasan setiap peserta. Jika setelah mengikuti 1 hari Full Training Anda merasa tidak beroleh manfaat sama sekali, lapor langsung ke panitia setelah acara selesai dan kami kembalikan uang pendaftaran secara penuh — tanpa syarat yang ribet.' },
    { q: 'Apakah training ini hanya diadakan di Jakarta?', a: 'Sementara ini kami hanya mengadakan di Jakarta, di Hotel DoubleTree by Hilton Kemayoran. Namun di setiap batch, peserta dari berbagai kota di Indonesia selalu hadir. Untuk penyelenggaraan di kota lain, bisa kami fasilitasi apabila ada minimal 15 peserta yang dikumpulkan oleh pihak pengundang.' },
    { q: 'Apakah training 1 hari ini termasuk penginapan?', a: 'Tidak termasuk. Training berlangsung dari pagi hingga sore, jadi peserta dari Jakarta tidak perlu menginap. Bagi peserta dari luar kota, hotel di sekitar Kemayoran atau di lokasi acara bisa dicari secara online.' },
    { q: 'Bagaimana cara mendaftar?', a: 'Klik tombol "Daftar Sekarang" di halaman ini. Anda akan langsung terhubung dengan tim kami via WhatsApp untuk menyelesaikan proses pendaftaran dan pembayaran.' },
];
