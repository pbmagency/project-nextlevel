    ...
    return (
        <>
            <SectionWrapper id="mentor-section" bg="white" className="py-20">
                ...
                <div className="mt-12 grid gap-10 lg:grid-cols-[2fr_3fr] lg:items-center lg:gap-12">
                    ...
                    <div className="flex flex-col items-center">
                        <img
                            ...
                            onClick={() =>
                                setLightboxSrc("/storage/mentor/hardyanto.webp")
                            }
                        />
                        <span className="mt-3 inline-block rounded-full border border-blue-600/30 px-4 py-1.5 text-sm font-semibold text-blue-300">
                            Achievement Motivator
                        </span>
                        <span className="mt-2 inline-block rounded-full border border-blue-600/30 px-4 py-1.5 text-sm font-semibold text-blue-300">
                    ...
                    <div>
                        ...
                        <p className="mt-2 font-semibold text-blue-400">
                            Achievement Motivator, Founder Next Level Training &
                            Motivation
                        </p>
                        ...
                        <p className="mt-4 text-base font-medium leading-relaxed text-slate-300">
                            ...
                            serta ratusan perusahaan nasional, multinasional,
                            dan BUMN.
                        </p>
                ...
                {/* Gallery */}
                <div className="mt-12">
                    <p className="mb-4 text-center text-sm font-semibold uppercase tracking-widest text-slate-300">
                        Dokumentasi Event
                    </p>
                    <div className="overflow-hidden rounded-2xl">
                        <img
                            ...
                            onClick={() =>
                                setLightboxSrc(
                                    "/storage/misc/offline-session.webp",
                                )
                            }
                        />
                    </div>
